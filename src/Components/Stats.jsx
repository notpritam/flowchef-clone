...
function Stats() {
  return (
    <>
      <div className="projects-reels">
        <div className="stats-container">
          <div className="single-stat">
            <span className="number">200</span>
            <span className="des">Projects Finished</span>
            <img></img>
          </div>
          <div className="single-stat">
            <span className="number">5</span>
            <span className="des">Years of Experience</span>
            <img></img>
          </div>
          <div className="single-stat">
            <span className="number">150</span>
            <span className="des">Clients Worldwide</span>
            <img></img>
          </div>
        </div>
